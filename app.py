...
nltk.download('punkt')  # Download punkt tokenizer for nltk
...
def pred(input_resume):
    if svc_model is None or tfidf is None or le is None:
        raise RuntimeError("Required model files are not loaded. Please check if they exist and are readable.")
